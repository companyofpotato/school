    ...
    switch(node->name)
    {
        ...
        case N_EXP_ADD :
            ...
            if(isArithmeticType(t1) && isArithmeticType(t2))
                ...
                result = t1;
            else if(isIntegralType(t1) && isPointerOrArrayType(t2))
                result = t2;
            else
    ...
    switch(id->kind)
    {
        ...
        case ID_PARM :
            if(id->type)
            {
                ...
                //usual uanry conversion of parm type
...
void semantic_warning(int i, int ll)
{
    ...
    switch(i)
    {
        case 11 : printf("incomplete types in assignment expression\n");break;
        case 12 : printf("incomplete types in argument or return expr\n");break;
        case 14 : printf("incomplete types in binary expression\n");break;
...
void semantic_error(int i, int ll, char *s)
{
    ...
    switch(i)
    {
        ...
        case 31 : printf("pointer type expr required in pointer expression\n");break;
        ...
        case 40 : printf("illegal expression type in relational operaion\n");break;
